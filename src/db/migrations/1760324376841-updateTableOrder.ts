...
export class UpdateTableOrder1760324376841 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "payment_method" character varying(50) NOT NULL DEFAULT 'COD'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "payos_order_code" integer`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum" AS ENUM('PENDING', 'PAID', 'CONFIRMED', 'SHIPPED', 'DELIVERED', 'CANCELED')`,
    );
    await queryRunner.query(
